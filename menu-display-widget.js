    ...
    return `
      <div class="menu-card" data-menu-id="${menu.id}">
        ...
        <div class="menu-card-actions">
          <a href="${menu.pdf_file}" class="btn-action btn-view" target="_blank">
            📄 PDF ansehen
          </a>
          <button onclick="menuWidget.downloadPDF('${menu.pdf_file}', '${menu.title}')" class="btn-action btn-download">
            💾 Herunterladen
          </button>
          <button onclick="menuWidget.downloadQR('${menu.id}', '${menu.title}')" class="btn-action btn-qr">
            📱 QR speichern
          </button>
          <button onclick="menuWidget.printQR('${menu.id}', '${menu.title}')" class="btn-action btn-print">
            🖨️ QR drucken
          </button>
        </div>
      </div>
...
const menuWidget = new MenuDisplayWidget();
